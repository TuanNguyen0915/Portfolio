                ...
                {getData(qualificationData, "experience").data.map(
                  (item, idx) => (
                    <div key={idx} className="group flex gap-4">
                      <div className="relative h-auto w-[1px] py-4">
                        <div className="h-full w-[1px] bg-muted-foreground"></div>
                        <div className="absolute -left-1 top-4 h-[10px] w-[10px] rounded-full bg-primary transition-all duration-500 group-hover:translate-y-20"></div>
                      </div>
                ...
                {getData(qualificationData, "education").data.map(
                  (item, idx) => (
                    <div key={idx} className="group flex h-[80px] gap-4">
                      <div className="relative h-full w-[1px] py-4">
                        <div className="h-full w-[1px] bg-muted-foreground"></div>
                        <div className="group-hover:translate-y-[48px] absolute -left-1 top-4 h-[10px] w-[10px] rounded-full bg-primary transition-all duration-500"></div>
                      </div>
                      <div className="flex w-full flex-col gap-2 border-b border-border">
                        <div className="flex items-center justify-between ">
                          <p className="flex-1 text-left font-medium">
